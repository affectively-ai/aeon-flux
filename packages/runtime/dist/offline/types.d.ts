 ...
 */
export type OperationType = 'create' | 'update' | 'delete' | 'session_update' | 'tree_update' | 'data_update' | 'presence_update' | string;
/**
 ...
 */
export type ResolutionStrategy = 'local-wins' | 'remote-wins' | 'last-modified' | 'merge' | 'manual';
/**
