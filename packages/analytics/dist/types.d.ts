...
export declare const MERKLE_ATTR = "data-aeon-merkle";
/** Data attribute for tree path */
export declare const PATH_ATTR = "data-aeon-path";
/** Data attribute for tree path hashes */
export declare const PATH_HASHES_ATTR = "data-aeon-path-hashes";
/** Data attribute for node type */
export declare const TYPE_ATTR = "data-aeon-type";
